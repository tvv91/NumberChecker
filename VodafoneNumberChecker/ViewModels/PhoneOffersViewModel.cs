...
namespace VodafoneNumberChecker.ViewModels
{
    public class PhoneOffersViewModel : INotifyPropertyChanged
    {
        ...
        private readonly IPhoneOffersExcelExporter _excelExporter;
        ...
        public PhoneOffersViewModel(IDataService dataService, IPhoneOffersExcelExporter excelExporter)
        {
        ...
        public async Task ExportToExcelAsync()
        {
            try
            {
                ...
                if (saveFileDialog.ShowDialog() == true)
                {
                    ...
                    var fileContent = await _excelExporter.ExportAsync(allOffers);
